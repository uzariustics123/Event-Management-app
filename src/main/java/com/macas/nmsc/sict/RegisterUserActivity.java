...
public class RegisterUserActivity extends AppCompatActivity {
                    ...
                    public void onResponse(
                        ...
                        if (!response.isEmpty()) {
                            ...
                            try {
                                ...
                                loader.hide();
                                showErrmsg(e + "/nResponse: " + response);
                                abortRegisteredUser();
                            }
                            if (status.equals("success")) {
                                ...
                                loader.hide();
                                showErrmsg("null response " + response);
                                abortRegisteredUser();
                            }
    ...
    private void succeslogin() {
        ...
        dialog.setTitle("Hoorrayy!").setMessage("You have succesfully made an acount. Let's get you in")
                .setPositiveButton("Log in", (jialog, which) -> {
                    finish();
                }).setCancelable(false)
                .show();
    }
